...
export default function publish() {
    ...
    const solutionPath = join(rootDir, 'kraftvaerk.umbraco.blockfilter.sln');
    const projectPath = join(rootDir, 'kraftvaerk.umbraco.blockfilter.Backend');
    const csprojectPath = join(projectPath, 'kraftvaerk.umbraco.blockfilter.Backend.csproj');
